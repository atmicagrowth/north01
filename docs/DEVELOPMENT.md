...
| `pnpm verify:search` | The Phase 12 search rules — query parsing, the suggest contract, ranking and tie-breaks, the empty and no-result states, and that both engines agree. Local database only |
