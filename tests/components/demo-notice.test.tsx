 ...
 *    the dialog.
 * 4. **Storage that throws does not trap the visitor**: Continue still closes the notice.
 */
...
import { DemoNotice, resetDemoNoticeForTests } from '@/components/shell/demo-notice'
import { DEMO_NOTICE_COPY, DEMO_NOTICE_KEY, DEMO_NOTICE_SEEN } from '@/lib/demo-notice'

beforeEach(() => {
  window.localStorage.clear()
  resetDemoNoticeForTests()
})
